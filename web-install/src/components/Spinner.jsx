function Spinner({ size = 'h-4 w-4', color = 'text-gray-200', fill = 'fill-purple-900' }) {
    return (
        <div role="status">
            <svg
                aria-hidden="true"
                className={`${size} ${color} ${fill} animate-spin`}
                viewBox="0 0 100 101"
                fill="none"
